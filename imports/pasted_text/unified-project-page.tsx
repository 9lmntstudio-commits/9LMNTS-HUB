...
const ALL_SERVICES = [
  ...
  },
  {
    ...
    type: "ai",
    price: "From $3,000",
    description: "DJing Element - AI-powered UX optimization",
    icon: Zap,
  },
  {
    id: "ai-visual-design",
    ...
    price: "From $2,000",
    description:
      "Graffiti Element - AI logo and brand identity",
    icon: Palette,
  },
  {
    id: "ai-innovation",
    ...
    type: "ai",
    price: "From $1,500",
    description: "Breaking Element - AI trend prediction",
    icon: Brain,
  },
  {
    id: "ai-interaction",
    ...
    type: "ai",
    price: "From $2,000",
    description: "Beatboxing Element - AI interactions",
    icon: Zap,
  },
  {
    ...
    type: "ai",
    price: "From $1,000",
    description: "Knowledge Element - AI content curation",
    icon: Brain,
  },
  {
    ...
    type: "ai",
    price: "From $2,500",
    description: "Fashion Element - Real-time trends",
    icon: Palette,
  },
  {
    ...
    type: "ai",
    price: "From $3,000",
    description: "Entrepreneurship Element - AI workflows",
    icon: Zap,
  },
  {
    id: "ai-multilingual",
    ...
    type: "ai",
    price: "From $3,500",
    description: "Language Element - AI translation",
    icon: Brain,
  },
  ...
  },
  {
    ...
    type: "creative",
    price: "$3,000-$8,000",
    description: "Online stores with payment",
    icon: Zap,
  },
  {
    id: "mobile-app",
  ...
  // EventOS Packages
  {
    ...
    type: "eventos",
    price: "$1,500",
    description: "EventOS Platform License + Basic Design",
    icon: Zap,
  },
  {
    id: "eventos-standard",
...
export function UnifiedStartProjectPage({
  selectedPlan,
  selectedServiceType,
  selectedServiceId,
  onNavigate,
}: UnifiedStartProjectPageProps) {
  const [step, setStep] = useState(1);
  const [filter, setFilter] = useState<
    "all" | "ai" | "creative" | "eventos"
  >("all");
  const [showUpsell, setShowUpsell] = useState(false);
  const [selectedUpsellPackage, setSelectedUpsellPackage] =
  ...
  const handleSubmit = async () => {
    try {
      ...
      try {
        ...
        if (selectedService?.type === "ai") {
          ...
          const creativeData = {
            ...
            expected_attendees:
              parseInt(formData.expectedAttendees) || null,
          };
      ...
      try {
        ...
        if (n8nResponse.ok) {
          console.log(
            "🚀 Lead sent to n8n automation successfully",
          );
          ...
          console.log(
            "⚠️ n8n webhook failed, but submission succeeded",
          );
      ...
      console.log(
        "🤖 LOA qualification handled by n8n automation",
      );
      ...
      <div className="max-w-4xl w-full bg-[#222222] rounded-2xl border border-[#FF7A00]/20 shadow-2xl">
        ...
        <div className="p-8 border-b border-white/10">
          ...
          <p className="text-gray-400">
            Transform your business with our AI-powered
            solutions
          </p>
          ...
          <div className="flex items-center justify-between mt-6">
            {[1, 2, 3, 4, 5].map((num) => (
              <div key={num} className="flex items-center">
                ...
                {num < 5 && (
                  <div
                    className={`w-16 h-1 mx-2 ${step > num ? "bg-[#FF7A00]" : "bg-white/10"}`}
                  />
                )}
              </div>
            ))}
          ...
          {step === 5 && !showUpsell && (
            <div>
              ...
              <div className="bg-[#1A1A1A] border border-white/10 rounded-lg p-6 space-y-4">
                <div>
                  <h3 className="text-[#FF7A00] font-bold mb-2">
                    Selected Service
                  </h3>
          ...
          {step === 5 && showUpsell && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-8">
                Thank you for selecting our premium package. Our
          ...
          {step === 6 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-8">
                ...
                review your project and contact you within 24
                hours.
              </p>
              <button
