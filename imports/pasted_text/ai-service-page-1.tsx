...
export default function AIservicepage() {
  ...
  const services = [
    {
      ...
      price: 2000,
      description:
        "AI-powered content strategy, automated social media management, brand voice consistency",
      features: [
    ...
    },
    {
      ...
      price: 1500,
      description:
        "Modern, responsive design, AI integration, SEO optimization",
      features: [
        "Responsive design",
        "AI integration",
        "SEO optimization",
    ...
    },
    {
      ...
      price: 3000,
      description:
        "Complete workflow automation, process optimization, revenue acceleration",
      features: [
        "Workflow automation",
    ...
    },
    {
      ...
      price: 1000,
      description:
        "Event management automation, AI-powered operations, white-label rights",
      features: [
        "Event management",
    ...
    },
    {
      ...
      price: 5000,
      description:
        "Tailored AI solutions, custom development, enterprise integration",
      features: [
        "Custom AI solutions",
  ...
  const handleSubmit = (e: any) => {
    ...
    fetch(
      ...
      .catch((error) => {
        alert(
          "Error submitting form. Please contact us directly at 9lmntstudio@gmail.com",
        );
      });
  };
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            automation. Complete workflow automation, process
            optimization, and revenue acceleration.
          </p>
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                  <h5 className="font-bold mb-2">
                    🎉 ACT NOW - AUTOMATION STARTS IMMEDIATELY!
                  </h5>
                  <p className="text-sm text-gray-600">
                    Contact us today and start your AI-powered
                    business transformation. All services
                    include immediate setup and ongoing support.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p>
              &copy; 2024 9LMNTS STUDIO. All rights reserved.
            </p>
            <p className="mt-2 text-gray-400">
              AI-powered automation solutions for modern
              businesses.
            </p>
          </div>
        </div>
