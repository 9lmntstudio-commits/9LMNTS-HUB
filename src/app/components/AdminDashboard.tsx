...
const PORTFOLIO_IMG = "https://images.unsplash.com/photo-1771873679764-4e5503b69040?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXJrJTIwbmVvbiUyMGFic3RyYWN0JTIwZ3JpZHxlbnwxfHx8fDE3Nzc5NjY3Mzh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral";
              ...
              <div className="relative z-10 flex flex-col h-full min-h-[220px]">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/60 mb-6 max-w-[200px]">
                    Track all your active OS instances and
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <div className="text-2xl font-bold flex items-center gap-2">
                    $6,094.96
                    <span className="px-2 py-0.5 rounded-md bg-[#10B981]/20 text-[#10B981] text-xs font-bold">
                      +8.2%
                    </span>
                  </div>
                </div>
...
function NavItem({
  ...
  return (
    ...
    >
      <Icon
        size={20}
        className={`transition-colors ${active ? "text-[#00D4FF]" : "group-hover:text-white"}`}
      />
...
function StatCard({
  ...
  return (
    <div className="bg-[#111] border border-white/5 rounded-3xl p-6 relative overflow-hidden group hover:border-white/10 transition-colors">
      ...
      <div className="mb-6">
        <h3 className="text-white/60 text-xs font-bold uppercase tracking-wider mb-1">
          {title}
        </h3>
        <div className="text-2xl font-bold flex items-end gap-2">
          {value}
          <span
            className={`text-xs font-bold px-1.5 py-0.5 rounded ${isDown ? "bg-[#E91E63]/20 text-[#E91E63]" : "bg-[#10B981]/20 text-[#10B981]"}`}
          >
            {change}
          </span>
        </div>
...
function TableRow({
  ...
  return (
    <div className="grid grid-cols-5 gap-4 items-center p-4 rounded-xl hover:bg-white/5 transition-colors cursor-pointer group">
      ...
      <div className="col-span-1">
        <span
          className={`text-xs font-bold ${isPositive ? "text-[#10B981]" : "text-[#E91E63]"}`}
        >
          {isPositive ? "Buy" : "Sell"}
        </span>
      </div>
