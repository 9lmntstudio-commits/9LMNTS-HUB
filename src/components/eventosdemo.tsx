...
// Using 'export' here ensures app.tsx can find "EventOSDemo"
export function EventOSDemo() {
  // Mock data for the component - replace with your actual data/props if needed
  const theme = {
    primary: '#D1FF00', // Neon Yellow/Green
    bannerImage: 'https://images.unsplash.com/photo-1574672280600-4accfa5b6f98'
  };
  ...
  const labels = {
    ...
    subtitle: "HORIZON",
    date: "OCT 24, 2026",
    venue: "9LMNTS VIRTUAL ARENA"
  };

  const storeItems = [
    { name: "General Admission", price: 25, desc: "Standard entry to the live stream" },
    { name: "VIP Pass", price: 75, desc: "Digital backstage access + NFT Badge" },
    { name: "Founders Circle", price: 250, desc: "Lifetime access to all OS events" }
  ];

  return (
    <div className="relative min-h-screen flex flex-col lg:flex-row overflow-hidden bg-[#1A1A1A] text-white">
      ...
      <motion.div 
        ...
        style={{ backgroundImage: `linear-gradient(to top, #1A1A1A 0%, transparent 100%), url(${theme.bannerImage})` }}
      >
        <div className="relative z-10">
          ...
          <h1 className="font-orbitron text-6xl lg:text-9xl leading-none mb-4 uppercase italic font-black">
            {labels.title}<br/>
          ...
          {storeItems.map((item, idx) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <div className="text-[10px] text-white/40 group-hover:text-white transition-colors uppercase tracking-widest">
                  Buy via PayPal →
                </div>
              </div>
            </motion.div>
