      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-8 inline-block">
            <span className="px-6 py-3 bg-white/80 backdrop-blur-sm border border-blue-200 rounded-full text-blue-600 text-sm font-semibold shadow-lg">
              Welcome to the Future
            </span>
          </div>
          
          <h1 className="text-5xl sm:text-6xl lg:text-8xl mb-8 tracking-tight font-bold">
            <span className="gradient-text">9LMNTS</span> <span className="text-blue-600">Studio</span><br />
            <span className="text-3xl sm:text-4xl lg:text-5xl text-gray-600 font-medium mt-4 block">Where Digital Design Meets Innovation</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto font-light leading-relaxed">
            Transform your vision into stunning digital experiences with cutting-edge AI technology 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button
              ...
              className="btn btn-primary text-lg px-8 py-4 shadow-xl animate-pulse-glow"
            >
              Start Your Project
