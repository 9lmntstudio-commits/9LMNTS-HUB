  ...
  const pricingTiers = [
    {
      ...
      price: '$1,500',
      planValue: 'basic',
      description: 'Rapid Launch & High-Converting Landing Page',
      features: [
        '7-Day Rapid Delivery Sprint',
        'Supabase Auth & Lead-Intake Edge Function',
        'Flame Orange Cyber Aesthetic UI',
        'Full Mobile & Desktop Responsiveness',
        'PayPal Complete Payments / Pay in 4 Integration',
        'SEO Meta & OpenGraph Telemetry',
      ],
      cta: 'Book 7-Day Sprint',
      popular: false,
    },
    {
      ...
      price: '$2,500',
      planValue: 'standard',
      description: 'Full-Stack Web App & Interactive Experience',
      features: [
        '7-Day Autonomous Execution Sprint',
        'Full-Stack React + Vite + Tailwind Architecture',
        'Supabase PostgreSQL Database & Realtime PubSub',
        'Interactive 2.5D Scroll Canvas & Keyframe Animations',
        '85vh Master Modal Drawer Shell Integration',
        'PayPal 1-Tap Checkout & Automated Webhooks',
        'Netlify Production Staging & Custom Domain Setup',
      ],
      cta: 'Book Pro Sprint',
      popular: true,
    },
    {
      ...
      price: '$5,000',
      planValue: 'premium',
      description: 'Turnkey Enterprise Platform & Custom Workflows',
      features: [
        'Everything in 7-Day Pro Agency',
        'Custom CRM & Client Portal Deployment',
        'AI Qualification Engine (Gemini 1.5 Flash Edge Function)',
        'Multi-Role Row-Level Security (RLS) Architecture',
        'High-Concurrency Live Telemetry & Jumbotron Display',
        'Dedicated Architecture Consultation with Darnley Sanon',
        'Priority 24/7 Production SLA & Git Handoff',
      ],
      cta: 'Book Enterprise Sprint',
      popular: false,
    },
    {
      ...
      price: '$15,000+',
      planValue: 'custom',
      description: 'High-Ticket BIM/CAD Architectural Digital Twin',
      features: [
        'Custom CAD/BIM Floorplan & Elevation Ingestion',
        'Interactive 2.5D Building Walkthrough Canvas',
        'Niantic WebAR 3D Architectural Model Previews',
        'Accredited Investor & Buyer Deal-Flow Portal',
        '50/25/25 Production Milestone Escrow',
        'White-Glove Drone Photogrammetry Integration',
      ],
      cta: 'Schedule Discovery Sprint ($250 Deposit)',
      popular: false,
    },
  ];
